...
<head>
    ...
    <script type="text/javascript">
        ...
        function daoruShujus(){
            $("#daoru").dialog("open").dialog("setTitle","导入信息");
            daoruurl="../daoruShuju";
        }
        ...
        function shangchuanShuju(){
            ...
            var row=selectedRows[0];
            $("#shangchuan").dialog("open").dialog("setTitle","上传信息");
        ...
        function chakanNeirong(shujuId, row) {
            return '<a style="color:red;"target="_blank" href="wangzhan/shujuneirong.jsp?shujuId=' + shujuId + '">查看' + '</a>';
        }
    </script>
</head>
...
<table id="dg" title="信息" class="easyui-datagrid" fitColumns="true"
       pagination="true" url="../getShujus?userId=1" fit="true" rownumbers="true" toolbar="#tb">
    <thead>
    <tr>
        ...
        <th field="shujuMark2" width="40">说明</th>
        <th field="shujuImgName" width="20" formatter="formatXiazai">下载</th>
...
<div id="tb">
    <div>
        ...
        <a href="javascript:shangchuanShuju()" class="easyui-linkbutton" iconCls="icon-add" plain="true">上传附件</a>
    </div>
    <div>
        &nbsp;名称：&nbsp;<input type="text" name="s_shujuName" id="s_shujuName" size="10"/>
        &nbsp;&nbsp;<input class="easyui-combobox" id="s_sjleixingId" name="s_sjleixingId"  data-options="panelHeight:'auto',editable:false,valueField:'sjleixingId',textField:'sjleixingName',url:'../sjleixingComboList'"/>
...
<div id="daoru" class="easyui-dialog" style="width: 320px;height: 140px;padding: 10px 20px"
    ...
    <form id="drfm" method="post" enctype="multipart/form-data">
        <table cellspacing="5px;">
            <tr>
                <td><input type="file" name="uploadFile" id="uploadFile1" class="easyui-validatebox" required="true"/></td>
            </tr>
        </table>
    </form>
</div>
