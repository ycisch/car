    ...
    <form id="editForm" method="post" action="#">
        ...
        <table id="editTable" style="border-collapse:separate; border-spacing:0 3px;" cellpadding="6">
            ...
            <tr>
                <td>名：</td>
                <td>
                    <input value="${userInfo.userLastName}" id="edit_userLastName" style="width: 200px; height: 30px;" class="easyui-textbox"
                ...
                <td colspan="1">
                    <select id="edit_userSex" class="easyui-combobox"
                            data-options="editable: false, panelHeight: 50, width: 60, height: 30,
                                required:true, missingMessage:'请选择状性别哟~'" name="userSex">
                        <option value="男" <c:if test="${userInfo.userSex == '男'}">selected</c:if> >男</option>
                        <option value="女" <c:if test="${userInfo.userSex == '女'}">selected</c:if> >>女</option>
                    </select>
                </td>
            </tr>
            <tr>
                <td>电话</td>
                <td colspan="1">
                    <input value="${userInfo.userPhone}" id="edit_userPhone" style="width: 200px; height: 30px;" class="easyui-textbox"
            ...
            <tr>
                <td>密码</td>
                <td colspan="1">
                    <input value="${userInfo.userPassword}" id="edit_userPassword" style="width: 200px; height: 30px;" class="easyui-textbox"
