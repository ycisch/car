...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#vcodeImg").click(function () {
                this.src = "${pageContext.request.contextPath}/user/getVerifiCodeImage?t=" + new Date().getTime();
            });
            //登录按钮事件
    ...
    <title>智能拼车系统 | 登录页面 </title>
    <meta name="keywords" content="智能拼车系统">
</head>
...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        <form id="form" class="form form-horizontal" method="post" action="#">
            <!-- 用户身份信息 -->
            <div class="row cl">
                <label class="form-label col-3"><i class="Hui-iconfont">用户名</i></label>
            ...
            <!-- 验证码 -->
            <div class="row cl">
                <label class="form-label col-3"><i class="Hui-iconfont">验证码</i></label>
                <div class="formControls col-8">
            ...
            <div class="mt-20 skin-minimal" style="text-align: center;">
                <div class="radio-box">
                    ...
                    <label for="radio-1" style="color: white;font-size: 20px">管理员</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="radio-2" name="userType" checked value="2"/>
                    <label for="radio-2" style="color: white;font-size: 20px">顾客</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="radio-3" name="userType" checked value="3"/>
                    <label for="radio-2" style="color: white;font-size: 20px">车主</label>
                </div>
            </div>
            <!-- 登录按钮 -->
            <div class="row">
