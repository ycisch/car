        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {
                        field: 'recordId', title: 'ID', width: 50, sortable: true,
                        sorter: function (a, b) {
                            return (a > b ? -1 : 1)
                        }
                    },
                    {field: 'recordStart', title: '开始地点', width: 150},
                    {field: 'recordEnd', title: '结束地点', width: 150},
                    ...
                    {field: 'endTime', title: '结束时间',
                        ...
                        width: 150},
                    {field: 'recordFare', title: '费用 ', width: 150},
                    {field: 'recordStatus', title: '状态', width: 150},
                    {
...
<div id="toolbar">
    ...
    <%--<div style="margin-left: 10px;">--%>
        ...
        <%--<a href="javascript:" class="easyui-linkbutton"--%>
           <%--data-options="iconCls:'icon-user-student',plain:true">开始时间</a>--%>
