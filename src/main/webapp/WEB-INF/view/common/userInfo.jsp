    ...
    <form id="editPassword" action="#" style="padding-left: 20px;padding-top: 15px">
        <table cellpadding="8">
            <tr>
                ...
                <td>姓名</td>
                <td>
                    <input id="old_name" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
            ...
            <tr>
                <td>密码:</td>
                <td>
                    <input id="old_password" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           value="${userInfo.ownerPassWord}"
                           name="ownerPassWord"/>
                </td>
            </tr>
            <tr>
                <td>电话:</td>
                <td>
                    <input id="old_phone" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"
                           value="${userInfo.ownerPhone}"
                           name="ownerPhone"/>
                </td>
            </tr>
            <tr>
                <td>生日:</td>
                <td>
                    <fmt:formatDate value="${userInfo.ownerBirth}" pattern="yyyy-MM-dd"/>
                </td>
            </tr>
            <tr>
                <td>居住地址:</td>
                <td>
                    ${userInfo.ownerLive.liveFloor}${userInfo.ownerLive.liveUnit}${userInfo.ownerLive.liveRoom}
                </td>
            </tr>
